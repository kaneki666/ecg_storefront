      ...
      >
        <div className="swiper-wrapper">
          <div
            ...
            style={{
              backgroundImage: "url(/images/demos/demo1/sliders/slide-1.jpg)",
          ...
          >
            <div className="container">
              <figure className="slide-image skrollable slide-animate">
                <img
                  src="/images/demos/demo1/sliders/shoes.png"
                  alt="Banner"
          ...
          <div
            ...
            style={{
              backgroundImage: "url(/images/demos/demo1/sliders/slide-2.jpg)",
              backgroundColor: "#ebeef2",
            }}
          >
            <div className="container">
              ...
              >
                <img
                  src="/images/demos/demo1/sliders/men.png"
                  alt="Banner"
          ...
          <div
            ...
            style={{
              backgroundImage: "url(/images/demos/demo1/sliders/slide-3.jpg)",
          ...
          >
            <div className="container">
              ...
              >
                <img
                  src="/images/demos/demo1/sliders/skate.png"
                  alt="Banner"
                  data-bottom-top="transform: translateY(10vh);"
                  data-top-bottom="transform: translateY(-10vh);"
                  width="310"
