...
import { DealProductsProps, SingleProductProps } from "../../utils/types/landingpage";


const HotDealsTheDay = ({ products }: { products: DealProductsProps }) => {
                ...
                <div className="col-md-6">
                  <div className="product-gallery product-gallery-sticky product-gallery-vertical">
                      ...
                      {productitem.product_media.map((item:any) => (
                        <div className="swiper-slide" key={item.id}>
                          <figure className="product-image">
                            <img
                              src={`https://ecomapi.mwebservices.co/.${item.file}`}
                    ...
                    >
                      ...
                      {productitem.product_media?.map((item:any, index:any) => (
                ...
                <div className="col-md-6">
                  <div className="product-details scrollable">
                    ...
                    <div className="product-price">
                      <ins className="new-price ls-50">{productitem.price}</ins>
                    </div>
