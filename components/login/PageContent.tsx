                    ...
                    <div className="tab-content">
                        ...
                        <div className="tab-pane" id="sign-up">
                            ...
                            <div className="form-checkbox user-checkbox mt-0">
                                ...
                                <label className="check-customer mb-1">I am a customer</label>
                                <br/>
                            ...
                            <div className="form-checkbox d-flex align-items-center justify-content-between mb-5">
                                ...
                                <label className="font-size-md">I agree to the <a  href="#" className="text-primary font-size-md">privacy policy</a></label>
                            </div>
