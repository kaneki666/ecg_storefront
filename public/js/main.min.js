    ...
    (Wolmart.$window = t(window)),
      ...
      (Wolmart.requestInterval = function (t, e, i) {
        var a =
          ...
          window.webkitRequestAnimationFrame ||
          window.mozRequestAnimationFrame;
        if (!a) return i ? setInterval(t, e) : setTimeout(t, i);
        var n,
          o,
          s = new Object();
        return (
          ...
          (function () {
            ...
            a.length ||
              ...
              (t(".page-wrapper").append(
                '<div class="compare-popup">                    <div class="container">                        <div class="compare-title">                            <h4 class="title title-center">Compare Products</h4>                        </div>                        <ul class="compare-product-list list-style-none">                            <li></li><li></li><li></li><li></li>                        </ul>                        <a href="#" class="btn btn-clean">Clean All</a>                        <a href="compare" class="btn btn-dark btn-rounded">Start Compare !</a>                    </div>                </div>                <div class="compare-popup-overlay">                </div>'
              ),
              (a = t(".page-wrapper > .compare-popup"))),
              Wolmart.$body
    ...
    (e.defaultOptions = {
      ...
      (Wolmart.slideContent = function (e) {
        ...
        i.on("click", function (t) {
          // checked worked after comment this line
          t.preventDefault(),
            a.hasClass("open")
